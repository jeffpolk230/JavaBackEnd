public class CnfTablesc{
static CatTag[] first;
static CatTag[] second;
...
public static Pair tokenToCats (boolean p, Symbol s){ 
switch (s.sym){ 
...
public static void main(String args[]){
	Pair p1 = tokenToCats(true, new Symbol(sym._INTEGER_));
	Pair p2 = tokenToCats(true, new Symbol(sym._SYMB_0));
	Pair p3 = tokenToCats(true, new Symbol(sym._INTEGER_));
	System.out.println(p2.first.show());
	System.out.println(p2.second.show());
}
}
